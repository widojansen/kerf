defmodule Kerf.Agents.EmailTriage.TopicTaxonomy do
  @moduledoc "Schema for `email_topic_taxonomy`. See `Kerf.Agents.EmailTriage.Taxonomy` for the public API."
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key {:value, :string, autogenerate: false}

  schema "email_topic_taxonomy" do
