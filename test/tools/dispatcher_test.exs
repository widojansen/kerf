defmodule ExClaw.Tools.DispatcherTest do
  ...
  describe "dispatch/3" do
    test "routes shell_exec to Shell module" do
      {manager, _dir} = start_mock_manager()
      opts = [container_manager: manager, group_id: "test_group", workspaces_dir: "/tmp"]
    ...
    test "routes file_read to FileOps module" do
      {_manager, workspaces_dir} = start_mock_manager()
      ...
      opts = [container_manager: nil, group_id: "test_group", workspaces_dir: workspaces_dir]
    ...
    test "returns error for unknown tool" do
      opts = [container_manager: nil, group_id: "test_group", workspaces_dir: "/tmp"]
  ...
  describe "tool_definitions/0" do
    test "returns Anthropic-format tool schemas" do
